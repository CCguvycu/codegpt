...
AI_TOOLS = {
    ...
    "cohere": {
        "name": "Cohere",
        "desc": "Cohere AI platform CLI",
        "bin": "cohere",
        "install": ["pip", "install", "cohere"],
        "default_args": [],
        "needs_key": "COHERE_API_KEY",
    },
    "groq-cli": {
        "name": "Groq",
        "desc": "Groq ultra-fast inference CLI",
        "bin": "groq",
        "install": ["pip", "install", "groq"],
        "default_args": [],
        "needs_key": "GROQ_API_KEY (free tier)",
    },
    "replicate": {
        "name": "Replicate",
        "desc": "Run ML models in the cloud",
        "bin": "replicate",
        "install": ["pip", "install", "replicate"],
        "default_args": [],
        "needs_key": "REPLICATE_API_TOKEN",
    },
    "together": {
        "name": "Together AI",
        "desc": "Open-source models in the cloud",
        "bin": "together",
        "install": ["pip", "install", "together"],
        "default_args": [],
        "needs_key": "TOGETHER_API_KEY",
    },
    "fireworks": {
        "name": "Fireworks AI",
        "desc": "Fast inference for open models",
        "bin": "fireworks",
        "install": ["pip", "install", "fireworks-ai"],
        "default_args": [],
        "needs_key": "FIREWORKS_API_KEY",
    },
    "cerebras": {
        "name": "Cerebras",
        ...
        "default_args": [],
        "needs_key": "CEREBRAS_API_KEY",
    },
    # --- Dev & Deploy CLIs ---
    "huggingface": {
        "name": "Hugging Face",
        "desc": "ML model hub CLI",
        "bin": "huggingface-cli",
        "install": ["pip", "install", "huggingface-hub"],
        "default_args": [],
        "needs_key": "HF_TOKEN (optional)",
    },
    "lmstudio": {
        "name": "LM Studio",
        "desc": "Local model manager",
        "bin": "lms",
...
COMMANDS = {
    ...
    "/mistral": "Launch Mistral AI CLI",
    "/cohere": "Launch Cohere CLI",
    "/groq-cli": "Launch Groq CLI (ultra-fast)",
    "/replicate": "Launch Replicate CLI",
    "/together": "Launch Together AI CLI",
    "/fireworks": "Launch Fireworks AI CLI",
    "/cerebras": "Launch Cerebras CLI",
    "/huggingface": "Launch Hugging Face CLI",
    "/lmstudio": "Launch LM Studio CLI",
